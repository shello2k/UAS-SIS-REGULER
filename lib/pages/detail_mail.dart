                    ...
                    children: [  
                      ElevatedButton.icon(  
                        onPressed: () async {  
                          ...
                          if (response.isTapConfirmButton) {  
                            await _updateSuratStatus("Rejected"); // Update status to "Rejected"  
                            ArtSweetAlert.show(  
                              context: context,  
                              artDialogArgs: ArtDialogArgs(  
                      ...
                      ElevatedButton.icon(  
                        onPressed: () async {  
                          ...
                          if (response.isTapConfirmButton) {  
                            await _updateSuratStatus("On Progress - Faculty"); // Update status to "On Progress - Faculty"  
                            ArtSweetAlert.show(  
                              context: context,  
                              artDialogArgs: ArtDialogArgs(  
                                type: ArtSweetAlertType.success,  
                        ...
                        label: Text('Approve', style: GoogleFonts.poppins(color: Colors.white)),  
                        style: ElevatedButton.styleFrom(  
